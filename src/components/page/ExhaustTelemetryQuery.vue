<template>
  <div class="content_box">
        ...
        <el-row>
          <el-col :span="6" style="display:flex;justify-content: flex-start;">
            <el-form-item label="车牌号码：">
              <el-input v-model="inputList.hphm" style="width:150px"  @keyup.enter.native="searchAll"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6" style="display:flex;justify-content: flex-start;">
          ...
          <el-col :span="6" style="display:flex;justify-content: flex-start;">
            <el-form-item label="车道序号：">
              <el-input v-model="inputList.cdxh" style="width:150px"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6" style="display:flex;justify-content: flex-start;">
          ...
          <!-- <el-col :span="6" style="display:flex;justify-content: flex-start;">
            <el-form-item label="不透光度结果>=">
              <el-input v-model="inputList.btgdjg" style="width:150px"></el-input>(pmm)
            </el-form-item>
          </el-col>
          <el-col :span="6" style="display:flex;justify-content: flex-start;">
            <el-form-item label="湿度>=">
              <el-input v-model="inputList.sd" style="width:150px"></el-input>(%)
            </el-form-item>
          </el-col> -->
        </el-row>
      </el-form>
    ...
    <div class="chare_box" style="padding-left:20px;padding-right:20px;margin-top:30px;position:relative;height:auto;height:550px;margin-bottom:0;">
       <el-table
        :data="tableList"
        border
        height="450"
    ...
    <check-selection :diaSta="checkShow" @dialogClose="closeSelection"></check-selection>
  </div>
</template>
...
export default {
  ...
  methods: { showPdfDialog(data, name) {
      let that=this;
      if (name == "jy") {
